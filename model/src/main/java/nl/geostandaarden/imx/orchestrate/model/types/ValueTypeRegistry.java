...
public final class ValueTypeRegistry {
    ...
    public ValueTypeRegistry() {
        register(
                newFactory(ScalarTypes.BOOLEAN),
                newFactory(ScalarTypes.DOUBLE),
                newFactory(ScalarTypes.FLOAT),
                newFactory(ScalarTypes.INTEGER),
                newFactory(ScalarTypes.LONG),
                newFactory(ScalarTypes.STRING));
    }

    public ValueTypeRegistry register(ValueTypeFactory<?>... valueTypeFactories) {
        Arrays.stream(valueTypeFactories)
                .forEach(valueTypeFactory ->

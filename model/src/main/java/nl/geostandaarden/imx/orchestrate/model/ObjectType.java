...
public final class ObjectType {
    ...
    private ObjectType(String name, @Singular List<Property> properties) {
        ...
        propertyMap = properties.stream().collect(Collectors.toUnmodifiableMap(Property::getName, Function.identity()));
        identityProperties = properties.stream().filter(Property::isIdentifier).toList();
    }

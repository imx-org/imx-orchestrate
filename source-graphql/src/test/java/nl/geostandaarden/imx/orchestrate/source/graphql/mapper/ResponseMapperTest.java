...
class ResponseMapperTest {
    ...
    void processFindOneResult_returnsMono() {
        ...
        var executionResult = Mono.just(ExecutionResult.newExecutionResult()
    ...
    void processFindOneResult_returnsMono_forNull() {
        var config = GraphQlOrchestrateConfig.builder().build();
        var executionResult =
                Mono.just(ExecutionResult.newExecutionResult().data(null).build());
    ...
    void processFindResult_returnsFlux() {
        var config = GraphQlOrchestrateConfig.builder().collectionSuffix("").build();
        var executionResult = Mono.just(ExecutionResult.newExecutionResult()
                .data(Map.of("test", Map.of("nodes", List.of(Map.of("testKey", "testValue")))))
                .build());
    ...
    void processFindResult_returnsFlux_withSuffix() {
        var config = GraphQlOrchestrateConfig.builder()
                ...
                .build();
        var executionResult = Mono.just(ExecutionResult.newExecutionResult()
                .data(Map.of("testCollection", Map.of("nodes", List.of(Map.of("testKey", "testValue")))))
                .build());
    ...
    void processBatchResult_returnsFlux() {
        var config = GraphQlOrchestrateConfig.builder().batchSuffix("").build();
        var executionResult = Mono.just(ExecutionResult.newExecutionResult()
                .data(Map.of("test", List.of(Map.of("testKey", "testValue"))))
                .build());
    ...
    void processBatchResult_returnsFlux_withSuffix() {
        ...
        var executionResult = Mono.just(ExecutionResult.newExecutionResult()
                .data(Map.of("testBatch", List.of(Map.of("testKey", "testValue"))))
                .build());

...
public final class ObjectRequest extends AbstractDataRequest {
  ...
  private ObjectRequest(Model model, ObjectType objectType, Set<SelectedProperty> selectedProperties) {
    super(model, objectType, selectedProperties);
  }

  public static ObjectRequest.Builder builder(Model model, String typeName) {
    return new Builder(model, model.getObjectType(typeName));
  }

  public static ObjectRequest.Builder builder(Model model, ObjectTypeRef typeRef) {
  ...
  public static class Builder extends AbstractDataRequest.Builder<Builder> {
    ...
    public ObjectRequest build() {
      return new ObjectRequest(model, objectType, unmodifiableSet(selectedProperties));
    }
